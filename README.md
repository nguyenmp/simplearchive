...
- [x] Enqueue + RunNext core: enqueues pending extractor_runs; RunNext claims a snapshot and runs its steps independently (no primary-fatal), rebuilding index.json per step.
